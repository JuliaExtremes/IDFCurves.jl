...
@time t = scalingtest(SimpleScaling, data, 30; tag_out="5min")

fm = t.fitted_model
F = t.null_distribution
S = t.test_statistic
...
Q = IDFCurves.CvMDistribution(λ)


s = CvMValidationTest(fm, S, Q)

@time decision_threshold(s)
